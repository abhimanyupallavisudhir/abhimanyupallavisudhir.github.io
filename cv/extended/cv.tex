...
\subsection*{AI Debate with OpenMath (Berkeley SPAR -- summer 2024)}

Ongoing collaboration with a team supervised by Arjun Panickssery and Nima Rimsky to use NVIDIA's OpenMath dataset to train AI debaters, as part of the Berkeley Supervised Program for Alignment Research.
